---
title: "Day 14 — Share & Reflect"
description: "Share your work, gather feedback, and reflect."
---
...
Pick at least one place to share your landing page:
...
**What to say:**
You don't need a long post. Something like:
...
Ask 2–3 people (friends, colleagues, fellow designers) to visit your page and tell you:
...
```
Pretend you're a senior product designer reviewing my landing page at [YOUR-URL]. Give me honest feedback on:
- Visual hierarchy and readability
- The flow from section to section
- Anything that feels inconsistent or unfinished
- One thing that works really well
```

---

### Step 3: Quick Iterations

Based on feedback, make 2–3 small improvements. Don't overhaul — just tighten:

```
Based on feedback, I want to make these quick fixes:
1. [Whatever feedback suggested]
2. [Another small fix]
3. [One more refinement]
```

Deploy the updated version. Done.

---

### Step 4: Reflect

Take a moment to look at what you've accomplished in Phase 2:
...
→ [Continue to Phase 3: Design Portfolio](../phase-3-design-portfolio/day-1.md)
